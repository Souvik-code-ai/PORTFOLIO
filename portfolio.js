...
x.addEventListener("click",()=>{
    let option=document.querySelector('input[name="option"]:checked');//This selects the checked radio button.
    console.log(option.value);//option.value: This retrieves the value of the selected radio button.
    if(option.value=="option1")
    {
        document.querySelector("#feedbackdiv").style.display="none";
        
    }
    else if((option.value=="option2")||(option.value=="option3"))
    {
        document.querySelector("#feedbackdiv").style.display="block";
        document.querySelector("#edit").style.display="none";
        a=document.createElement("a");
        a.innerText="feedback";
        a.style.color="black";
        a.href="#feedbackdiv";
        document.querySelector("#form").append(a);
        /*a.innerText="feedback";
        a.style.href="#feedbackdiv";
        a.style.class="do";
        x.after(a);*/
    }
});
